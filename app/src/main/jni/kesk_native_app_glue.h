 ...
 */
#ifndef _KESK_NATIVE_APP_GLUE_H
#define _KESK_NATIVE_APP_GLUE_H
...
struct android_app {
    ...
    // Fill this in with the function to process user's commands
    void (*onUserCmd)(struct android_app* app, void** data);

    // Fill this in with the function to process main app commands (APP_CMD_*)
    void (*onAppCmd)(struct android_app* app, int32_t cmd);

    // Fill this in with the function to process to clean GL
    void (*onDestroy)(struct android_app* app);
    ...
    // The ALooper associated with the UI's thread.
	ALooper* uiLooper;
    ...
    struct android_poll_source userCmdPollSource;
