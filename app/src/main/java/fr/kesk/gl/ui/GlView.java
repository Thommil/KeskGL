 ...
 *
 */
public class GlView extends SurfaceView implements SurfaceHolder.Callback, ContextManager {
    
	private final static String TAG = GlView.class.getName();
    ...
    private final WeakReference<GlView> mThisWeakRef = new WeakReference<GlView>(this);
     ...
     * {@link GlView#setEGLContextFactory(EGLContextFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link GlView#setEGLWindowSurfaceFactory(EGLWindowSurfaceFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link GlView#setEGLConfigChooser(EGLConfigChooser)}
     */
    ...
    private static class EglHelper {
        public EglHelper(WeakReference<GlView> GLSceneViewWeakRef) {
        ...
        private WeakReference<GlView> mGLSceneViewWeakRef;
        EGL10 mEgl;
    ...
    static class GLThread extends Thread {
    	...
    	GLThread(WeakReference<GlView> GLSceneViewWeakRef) {
            super();
            mWidth = 0;
            mHeight = 0;
            mGLSceneViewWeakRef = GLSceneViewWeakRef;
