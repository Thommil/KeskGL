...
import fr.kesk.gl.loader.API;
import fr.kesk.gl.loader.BinaryLoader;
 ...
 * <ul>
 * <li>list all objects and instances</li>
 * <li>one instance of GlAsset is held by GlContext</li>
 * <li>helpers to free resources</li>
 * <li>output inner format of {@link BinaryLoader}</li>
 * </ul>
 * 
...
public class GlAssets {
	...
	public final static class Geometry{
		 ...
		 */
		public Geometry(final int id, final Element[] elements){
		...
		public final static class Element{
			 ...
			 * @param handle The VBO handle (GlBuffer.UNBIND_HANDLE if VBO not bound)
			 * @param values The values bound to inputs (null if only VBO)
			 */
